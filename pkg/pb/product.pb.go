...
var file_pkg_pb_product_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
...
var file_pkg_pb_product_proto_depIdxs = []int32{
	...
	1, // 5: product.ProductService.FindAll:output_type -> product.FindAllResponse
	7, // 6: product.ProductService.DecreaseStock:output_type -> product.DecreaseStockResponse
	3, // 7: product.ProductService.FindOne:output_type -> product.FindOneResponse
